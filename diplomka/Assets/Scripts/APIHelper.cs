...
public static class APIHelper
{
    ...
    {
        return JsonConvert.DeserializeObject<List<Classroom>>(
            GetDataObjectJson(Constants.ClassroomsGetByTeacherIdEndpointUrl + "/" + teacherId));
    }

    public static ClassroomTask GetClassroomTask(int classroomId, int taskId)
    {
        return JsonUtility.FromJson<ClassroomTask>(
            GetDataObjectJson(Constants.ClassroomTaskEndpointUrl + "/" + classroomId + "/" + taskId));
    }
    ...
    public static List<Group> GetGroupsInClassroom(int classroomId)
    {
        return JsonConvert.DeserializeObject<List<Group>>(
            GetDataObjectJson(Constants.GroupsGetByClassroomIdEndpointUrl + "/" + classroomId));
    }

    public static List<Group> GetStudentsGroups(int studentId)
    {
        return JsonConvert.DeserializeObject<List<Group>>(
            GetDataObjectJson(Constants.GroupsGetByStudentIdEndpointUrl + "/" + studentId));
    }

    public static List<Group> GetGroupsFromInClassroomNotInStudent(int classroomId, int studentId)
    {
        return JsonConvert.DeserializeObject<List<Group>>(GetDataObjectJson(
            Constants.GroupsGetByClassroomIdNotInStudentIdEndpointUrl + "/" + classroomId + "/" + studentId));
    }

    public static GroupTask GetGroupTask(int groupId, int taskId)
    {
        return JsonUtility.FromJson<GroupTask>(
            GetDataObjectJson(Constants.GroupTaskEndpointUrl + "/" + groupId + "/" + taskId));
    }
    ...
    {
        return JsonUtility.FromJson<Student>(
            GetDataObjectJson(Constants.StudentGetByLoginEndpointUrl + "/" + userName + "/" + password));
    }
    ...
    public static List<Student> GetStudentsInGroup(int groupId)
    {
        return JsonConvert.DeserializeObject<List<Student>>(
            GetDataObjectJson(Constants.StudentsGetByGroupIdEndpointUrl + "/" + groupId));
    }

    public static List<Student> GetStudentsFromClassroomNotInGroup(int classroomId, int groupId)
    {
        return JsonConvert.DeserializeObject<List<Student>>(GetDataObjectJson(
            Constants.StudentsGetByClassroomIdNotInGroupIdEndpointUrl + "/" + classroomId + "/" + groupId));
    }

    public static List<Student> GetStudentsInClassroom(int classroomId)
    {
        return JsonConvert.DeserializeObject<List<Student>>(
            GetDataObjectJson(Constants.StudentsGetByClassroomIdEndpointUrl + "/" + classroomId));
    }

    public static StudentGroup GetStudentGroup(int studentId, int groupId)
    {
        return JsonUtility.FromJson<StudentGroup>(
            GetDataObjectJson(Constants.StudentGroupEndpointUrl + "/" + studentId + "/" + groupId));
    }

    public static StudentTask GetStudentTask(int studentId, int taskId)
    {
        return JsonUtility.FromJson<StudentTask>(
            GetDataObjectJson(Constants.StudentTaskEndpointUrl + "/" + studentId + "/" + taskId));
    }
    ...
    {
        return JsonConvert.DeserializeObject<List<Taskk>>(
            GetDataObjectJson(Constants.TasksGetByClassroomIdEndpointUrl + "/" + classroomId));
    }

    public static List<Taskk> GetGroupsTasks(int groupId)
    {
        return JsonConvert.DeserializeObject<List<Taskk>>(
            GetDataObjectJson(Constants.TasksGetByGroupIdEndpointUrl + "/" + groupId));
    }

    public static List<Taskk> GetStudentsTasks(int studentId)
    {
        return JsonConvert.DeserializeObject<List<Taskk>>(
            GetDataObjectJson(Constants.TasksGetByStudentIdEndpointUrl + "/" + studentId));
    }

    public static List<Taskk> GetTasksFromTeacherNotInGroup(int teacherId, int groupId)
    {
        return JsonConvert.DeserializeObject<List<Taskk>>(
            GetDataObjectJson(Constants.TasksGetByTeacherIdNotInGroupIdEndpointUrl + "/" + teacherId + "/" + groupId));
    }
    ...
    public static List<Taskk> GetTasksFromTeacherNotInStudent(int teacherId, int studentId)
    {
        return JsonConvert.DeserializeObject<List<Taskk>>(
            GetDataObjectJson(
                Constants.TasksGetByTeacherIdNotInStudentIdEndpointUrl + "/" + teacherId + "/" + studentId));
    }
    ...
    {
        return JsonUtility.FromJson<Teacher>(
            GetDataObjectJson(Constants.TeacherGetByUserNameEndpointUrl + "/" + userName));
    }

    public static Teacher GetTeacherByLogin(string userName, string password)
    {
        return JsonUtility.FromJson<Teacher>(
            GetDataObjectJson(Constants.TeacherGetByLoginEndpointUrl + "/" + userName + "/" + password));
    }
